...
// todo 6: спробувати розширити SIGNUP скрін до функціоналу згідно дизайну з чекбоксами, подвійним паролем і т.д.
// todo 7: спробувати додати іконки до інпутів  SIGNUP скрін (мейл і пас)
// todo 8: зробити стрілку-кнопку-іконку замість кнопки back  SIGNUP скрін
// todo 9: скіпнув урок Chapter 26 - Unit Testing our AuthService - Free Flutter Course (vandad)
